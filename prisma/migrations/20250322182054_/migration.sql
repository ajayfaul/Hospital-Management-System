...
-- CreateEnum
CREATE TYPE "JOBTYPE" AS ENUM ('FULL', 'CONTRACT', 'INTERN');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH', 'CREDIT_CARD', 'DEBIT_CARD', 'PAYPAL', 'BANK_TRANSFER');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'PAID', 'OVERDUE', 'REFUNDED', 'PARTIALLY_PAID', 'FAILED');

-- AlterTable
ALTER TABLE "Patient" DROP COLUMN "insurance_id",
DROP COLUMN "insurance_name",
DROP COLUMN "phone_number",
ADD COLUMN     "alleries" TEXT,
